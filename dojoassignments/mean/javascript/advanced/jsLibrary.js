...
var doubleList = _.map([1,2,3,4], function(num) {return num * 2})
console.log(doubleList)

var reduceList = _.reduce([1,2,3,4], function(num, memo) {return num + memo}, 0)
console.log(reduceList)

var find2 = _.find([1,3,5,2,3,5], function(num) {return num === 2})
console.log(find2)

var findFirstEven = _.find([3,5,7,5,4,5], function(num) {return num % 2 === 0})
console.log(findFirstEven)

var divisBy7 = _.filter([7,13,14,15,21,22,5], function(num) {return num % 7 === 0})
console.log(divisBy7)

var notDivisBy7 = _.reject([7,13,14,15,21,22,5], function(num) {return num % 7 === 0})
